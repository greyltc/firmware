...
#define ENC_COMMUTATION(n)	(((n)&0x1)<<3) 	/**< DESCRIPTION PENDING */
...
#define TSTEP				0x12	/**< DESCRIPTION PENDING */
...
#define VZERO_BIT			1<<10	/**< DESCRIPTION PENDING */

#define XLATCH				0x36	/**< Latches  XACTUAL  upon  a programmable switch event*/

#define ENCMODE				0x38		/**< DESCRIPTION PENDING */
#define X_ENC				0x39		/**< DESCRIPTION PENDING */
#define ENC_CONST			0x3A		/**< DESCRIPTION PENDING */
